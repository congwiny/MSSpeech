...
//
package com.msspeech.demo.microsoft;
...
import com.msspeech.msspeech.MicrophoneStream0;
...
public class MainActivity extends FragmentActivity {
    ...
    private static final String SpeechSubscriptionKey = "b301e554220b49ec8b658e0a9e6f7ba2";
    ...
    private MicrophoneStream0 microphoneStream;
    private MicrophoneStream0 createMicrophoneStream() {
        this.releaseMicrophoneStream();

        microphoneStream = new MicrophoneStream0();
