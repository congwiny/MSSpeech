package com.qihoo.superbrain.voicewake2.media
...
class PcmAudioPlayer @JvmOverloads constructor(val context: Context) {
     ...
     * 音频播放回调
     */
    private var pcmAudioPlayerListener: PcmPlayerListener? = null
...
//                                    audioTrack?.let { initAudioTrack() }
    ...
    private fun createNewFile(): File {
        return File(context.externalCacheDir, "pap${System.currentTimeMillis()}.pcm").apply {
            delete()
        }
    }
